...
namespace L2.Studio.Migrations.Migrations
{
    ...
    [Migration("20260818182426_AddNpcSpawns")]
    partial class AddNpcSpawns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("L2.Studio.Context.Entities.NpcSpawn", b =>
                {
                    b.Property<string>("GameVersion")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                    ...
                    b.ToTable("npc_spawns", "content");
                });

            modelBuilder.Entity("L2.Studio.Context.Entities.NpcSpawnEntity", b =>
                {
                    b.Property<string>("GameVersion")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                    ...
                    b.Property<string>("NpcSpawnName")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("npc_spawn_name");
                    ...
                    b.Property<int>("RespawnDelaySeconds")
                        .HasColumnType("integer")
                        .HasColumnName("respawn_delay_seconds");
                    ...
                    b.HasKey("GameVersion", "NpcSpawnName", "Sequence");

                    b.HasIndex("GameVersion", "NpcId")
                        .HasDatabaseName("ix_npc_spawn_entities_npc_id");

                    b.ToTable("npc_spawn_entities", "content");
                });

            modelBuilder.Entity("L2.Studio.Context.Entities.NpcSpawnZone", b =>
                {
                    b.Property<string>("GameVersion")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                    ...
                    b.ToTable("npc_spawn_zones", "content");
                });

            modelBuilder.Entity("L2.Studio.Context.Entities.NpcSpawnZoneEntity", b =>
                {
                    b.Property<string>("GameVersion")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                    ...
                    b.Property<string>("NpcSpawnZoneName")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("npc_spawn_zone_name");
                    ...
                    b.Property<int?>("RespawnRandomSeconds")
                        .HasColumnType("integer")
                        .HasColumnName("respawn_random_seconds");

                    b.HasKey("GameVersion", "NpcSpawnZoneName", "Sequence");

                    b.HasIndex("GameVersion", "NpcId")
                        .HasDatabaseName("ix_npc_spawn_zone_entities_npc_id");

                    b.ToTable("npc_spawn_zone_entities", "content", t =>
                        {
                            t.HasCheckConstraint("ck_npc_spawn_zone_entities_count", "count > 0");
                        });
                });

            modelBuilder.Entity("L2.Studio.Context.Entities.NpcSpawnZoneTerritory", b =>
                {
                    b.Property<string>("GameVersion")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                    ...
                    b.Property<short>("MaxZ")
                        .HasColumnType("smallint")
                        .HasColumnName("max_z");

                    b.Property<short>("MinZ")
                        .HasColumnType("smallint")
                        .HasColumnName("min_z");

                    b.HasKey("GameVersion", "NpcSpawnZoneName");

                    b.ToTable("npc_spawn_zone_territories", "content", t =>
                        {
                            t.HasCheckConstraint("ck_npc_spawn_zone_territories_z_bounds", "min_z <= max_z");
                        });
                });

            modelBuilder.Entity("L2.Studio.Context.Entities.NpcSpawnZoneTerritoryNode", b =>
                {
                    b.Property<string>("GameVersion")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                    ...
                    b.ToTable("npc_spawn_zone_territory_nodes", "content");
                });
            ...
            modelBuilder.Entity("L2.Studio.Context.Entities.NpcSpawnEntity", b =>
                {
                    ...
                    b.HasOne("L2.Studio.Context.Entities.NpcSpawn", "NpcSpawn")
                        .WithMany("Entities")
                        .HasForeignKey("GameVersion", "NpcSpawnName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("NpcSpawn");
                });
            ...
            modelBuilder.Entity("L2.Studio.Context.Entities.NpcSpawnZoneEntity", b =>
                {
                    ...
                    b.HasOne("L2.Studio.Context.Entities.NpcSpawnZone", "NpcSpawnZone")
                        .WithMany("Entities")
                        .HasForeignKey("GameVersion", "NpcSpawnZoneName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("NpcSpawnZone");
                });
            ...
            modelBuilder.Entity("L2.Studio.Context.Entities.NpcSpawnZoneTerritory", b =>
                {
                    ...
                    b.HasOne("L2.Studio.Context.Entities.NpcSpawnZone", "NpcSpawnZone")
                        .WithOne("Territory")
                        .HasForeignKey("L2.Studio.Context.Entities.NpcSpawnZoneTerritory", "GameVersion", "NpcSpawnZoneName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("L2.Studio.Context.Entities.NpcSpawnZoneTerritoryNode", b =>
                {
                    ...
                    b.HasOne("L2.Studio.Context.Entities.NpcSpawnZoneTerritory", "Territory")
                        .WithMany("Nodes")
                        .HasForeignKey("GameVersion", "NpcSpawnZoneName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
